...
app.add_url_rule('/C8CDC5F3D46143B664D72D039B5832FC', methods=['POST',], view_func=views.set_inout_history)

# Insert Device History information
app.add_url_rule('/57C5A9EEA786CD47EE17D720420493FA', methods=['POST',], view_func=views.get_initalize_information)
